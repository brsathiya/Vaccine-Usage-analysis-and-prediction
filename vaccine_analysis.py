...
def predict_price(h1n1_worry,h1n1_awareness,antiviral_medication,contact_avoidance,bought_face_mask,wash_hands_frequently,
    ...
    with open("C:/Users/karth/OneDrive/Desktop/program/Classification_model.pkl","rb") as f:
...
df= pd.read_csv(r"C:/Users/karth/OneDrive/Desktop/program/Vaccine_proper.csv")
...
if Menu == "Home":
    ...
    st.subheader(":orange[1. OBJECTIVE:]")

    st.write('''***1.Understand the complete dataset as per the needs***''')
